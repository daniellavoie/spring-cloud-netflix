...
import org.springframework.cloud.netflix.hystrix.security.app.CustomCommandExecutionHookImpl;
...
public class HystrixSecurityTests {
	@Autowired
	private CustomCommandExecutionHook customCommandHook;
	...
	public void testFeignHystrixSecurity() {
		...
		Assert.assertTrue("Custom hook should have been called.",
				((CustomCommandExecutionHookImpl) customCommandHook).isHookCalled());
	}
